...
import { Breadcrumb, Button, Container, Header, Segment } from 'semantic-ui-react';
...
import { NoticeDetailContentsTab } from './NoticeDetailContentsTab';
...
@observer
@reactAutobind
class NoticeDetailView extends React.Component<Props> {
  //
  render() {
    const {
      post,
        ...
        <div className="content">
          <div className="post-detail">
            <Segment.Group>
              ...
              <NoticeDetailContentsTab contents={post.contents} langSupports={post.langSupports} />
              {/*<Segment>*/}
              {/*  <div*/}
              {/*    dangerouslySetInnerHTML={{*/}
              {/*      __html:*/}
              {/*        getPolyglotToAnyString(*/}
              {/*          post.contents.contents.find((content) => content.exposureType === 'PC')?.contents,*/}
              ...
              {/*      __html:*/}
              {/*        getPolyglotToAnyString(*/}
              {/*          post.contents.contents.find((content) => content.exposureType === 'Mobile')?.contents,*/}
              {/*          getDefaultLanguage(post.langSupports)*/}
              {/*        ) || '',*/}
              {/*    }}*/}
              {/*  />*/}
