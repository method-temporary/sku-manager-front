...
import { DataCardMappingListQueryModel } from './DataCardMappingListQueryModel';

class DataCardMappingListRdo {
  college: string = '';
  channel: string = '';
  name: string = '';
  startDate: number = 0;
  ...
  constructor(searchModel?: DataCardMappingListQueryModel, pageModel?: PageModel) {
...
export default DataCardMappingListRdo;
