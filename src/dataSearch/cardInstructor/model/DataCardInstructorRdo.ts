...
import { DataCardInstructorQueryModel } from './DataCardInstructorQueryModel';

class DataCardInstructorRdo {
  college: string = '';
  channel: string = '';
  name: string = '';
  // startDate: number = 0;
  ...
  constructor(searchModel?: DataCardInstructorQueryModel, pageModel?: PageModel) {
    if (searchModel && pageModel) {
      Object.assign(this, {
        ...
        //     ? ''
        //     : (searchModel.hasStamp.toUpperCase() == 'YES' ? 1 : 0),
        searchable:
...
export default DataCardInstructorRdo;
