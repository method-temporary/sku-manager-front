...
export class DataMetaCardQueryModel extends QueryModel {
  college: string = '';
  channel: string = '';
  searchPart: string = '';
  name: string = '';
  ...
  constructor(metaCardQueryModel?: DataMetaCardQueryModel) {
    super();

    if (metaCardQueryModel) {
      Object.assign(this, {
        ...metaCardQueryModel,
      });
    }
...
decorate(DataMetaCardQueryModel, {
  college: observable,
  channel: observable,
  name: observable,
