...
export class DataCubeInstructorQueryModel extends QueryModel {
  college: string = '';
  channel: string = '';
  searchPart: string = '';
  name: string = '';
  ...
  constructor(cubeInstructorQueryModel?: DataCubeInstructorQueryModel) {
    super();

    if (cubeInstructorQueryModel) {
      Object.assign(this, {
        ...cubeInstructorQueryModel,
      });
    }
  }
...
decorate(DataCubeInstructorQueryModel, {
  college: observable,
  channel: observable,
  name: observable,
