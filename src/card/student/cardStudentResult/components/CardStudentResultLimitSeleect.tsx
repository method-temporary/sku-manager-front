...
export const CardStudentResultLimitSelect = observer(() => {
  //
  const { cardStudentResultParams, setLimit, setOffset, setParams } = CardStudentResultStore.instance;
  ...
  return (
    <Select
      ...
      value={cardStudentResultParams.limit}
